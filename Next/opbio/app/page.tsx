      ...
      <div className="wrapper">
        ...
        <header>
          <div className="leftSide">
            ...
            <p>Mark your digital presence with ease.Mark your digital presence with ease.Mark your digital presence with
              ease.Mark your digital presence with ease.</p>
        ...
        <div className="section2">
          <div className="joinToOur">
            ...
            <div className="buttonsSection2">
              ...
              <Link href="/register" className="btn2">Register</Link>
            </div>
          </div>
